...
public class DashboardController implements Initializable{
    ...
    private void setFields() {
        ...
        lblTotalDueAmount.setText(totalDueAmount.toString() + " Rs");

        //Setting todays sell amount
        lblTodaySellCtr.setText(todaySellCtr.toString());
        lblTodaysSellAmount.setText(todaysTotalSell.toString() + " Rs");

        //Setting todays rent amount
        lblTodaysRentalAmount.setText(todayTotalRental.toString() + " Rs");
        lblTodaysRentalCtr.setText(todaysRentalCtr.toString());

        //Setting todays due
        lblTodaysDueAmount.setText(todaysTotalDue.toString() + " Rs");
